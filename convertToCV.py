...
# Ler o arquivo resultado.xlsx em vez da pasta input_excels
input_file = "resultado.xlsx"
...
if os.path.exists(input_file):
    ...
    print("CVs gerados na pasta CVs/")
else:
    print("Arquivo resultado.xlsx não encontrado.")
